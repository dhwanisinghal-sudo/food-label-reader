...
|---|---|---|---|---|---|---|
| calories | 8 | 6 | 2 | 0 | 75.0% | 0.00 |
| total_fat_g | 8 | 2 | 2 | 4 | 25.0% | 0.04 |
| saturated_fat_g | 8 | 6 | 0 | 2 | 75.0% | 0.25 |
| trans_fat_g | 8 | 3 | 0 | 5 | 37.5% | 0.00 |
| cholesterol_mg | 8 | 4 | 0 | 4 | 50.0% | 0.00 |
| sodium_mg | 8 | 3 | 2 | 3 | 37.5% | 0.00 |
| total_carbs_g | 8 | 4 | 1 | 3 | 50.0% | 0.00 |
| fiber_g | 7 | 2 | 3 | 2 | 28.6% | 0.20 |
| total_sugars_g | 8 | 3 | 2 | 3 | 37.5% | 0.00 |
| added_sugars_g | 5 | 2 | 0 | 3 | 40.0% | 0.00 |
| protein_g | 8 | 4 | 1 | 3 | 50.0% | 0.00 |

**Overall field accuracy: 39/84 = 46.4%**

## Sample-size caveat

This is a **8-photo** evaluation. Treat it as a directional smoke test, not a benchmark:
- Overall field accuracy is 46.4%, but resampling the photos gives a 95% bootstrap interval of **23.8% - 70.5%**. Fields within one photo are correlated (a blurry photo fails on almost every field at once), so the effective sample is closer to the number of photos than to the number of fields.
...
## Failure cases: 48 logged -> see failure_cases.csv
