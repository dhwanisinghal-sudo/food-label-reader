...
| added_sugars_g | 5 | 3 | 0 | 2 | 60.0% | 0.00 |
| protein_g | 8 | 5 | 0 | 3 | 62.5% | 0.00 |

**Overall field accuracy: 53/84 = 63.1%**

## Sample-size caveat

This is a **8-photo** evaluation. Treat it as a directional smoke test, not a benchmark:
- Overall field accuracy is 63.1%, but resampling the photos gives a 95% bootstrap interval of **38.1% - 85.7%**. Fields within one photo are correlated (a blurry photo fails on almost every field at once), so the effective sample is closer to the number of photos than to the number of fields.
